...
- Frontend: `/restaurants` (browse list), `/restaurants/:id` (menu with per-product variant/add-on/quantity picker and "Add to cart", including the replace-cart confirmation flow), `/cart` (quantity controls, remove, clear, subtotal, disabled "Checkout coming soon" placeholder).

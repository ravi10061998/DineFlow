...
- `paymentStatus` only ever ends up `PENDING` in this module — flagged, real payment integration is Module 17 (same "build the shape now, wire it later" pattern as Module 4's immediate-activation subscriptions).

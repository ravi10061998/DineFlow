 ...
 * restart -- is exactly why `CloudflareR2StorageGateway` exists as the other implementation of
...
export class LocalDiskStorageGateway implements FileStorageGateway {
  // mimeType is part of FileStorageGateway's shared contract (R2 needs it for ContentType) but
